...
// dn.setOrigin(0,0);
this.dn.setPosition(600/2,600/2)
this.dn2.setPosition(500/2,100/2)
this.dn3.setPosition(800/2,100/2)
...
let conditionLeft=this.dn2.y<=50&&this.dn2speed<0
let conditionRight=this.dn2.y>=300&&this.dn2speed>0

this.dn2.y+=this.dn2speed
...
if(this.input.activePointer.isDown){
    this.pla.y+=this.plaspeed
}

let conditionup=this.dn3.y<=50&&this.dn3speed<0
let conditiondwn=this.dn3.y>=500&&this.dn3speed>0

this.dn3.y+=this.dn2speed

if(conditionup||conditiondwn){
    this.dn3speed*=-1
    // this.dn2.x+=this.dn2speed
}
